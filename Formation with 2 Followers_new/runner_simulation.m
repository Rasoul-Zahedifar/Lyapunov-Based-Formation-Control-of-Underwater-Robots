...
l1d=3;sai1_d=pi/2+5*pi/6;                   
l2d=3;sai2_d=pi/2+pi/6;


gg=5;                                %%%%%%
q0=[gg gg 1]'.*[4 -4 pi/2]';         %%%%%% Formation 1
q0_1=[gg gg 1]'.*[6 -3 pi/3]';       %%%%%%
q0_2=[gg gg 1]'.*[5 -3 pi/2]';
...
for i=[1 150 500 800 1200 1600 1900 2200]
